...
export default function ShaverBladesPage() {
  return (
    <>
      <PageHero
        eyebrow="Microdebrider Shaver Blades"
        title="High-quality blades. Consistent across cases."
        description="A core ENT consumable engineered for clean tissue removal. Compatible with major microdebrider systems. Backed by an experienced sales team that supports your OR staff before, during, and after the sale."
      >
